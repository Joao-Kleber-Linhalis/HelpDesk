...
public class DBService {
	...
	public void instaciaDB() {
		Tecnico tec1 = new Tecnico("Valdir Cesar", "14951880784","jklinhalis@gmail.com","123");
		tec1.addPerfil(Perfil.ADMIN);
		
		Cliente cli1 = new Cliente("Linus  Torvards", "14951880785", "torvads@mail.com", "123");
		
		Chamado c1 = new Chamado(Prioridade.MEDIA, Status.ANDAMENTO, "Chamado 01", "Primeiro Chamado", tec1, cli1);

		Tecnico tec2 = new Tecnico("Fernanda Silva", "987654321", "fernanda.silva@example.com", "password");
		tec2.addPerfil(Perfil.TECNICO);

		Cliente cli2 = new Cliente("John Doe", "123456789", "john.doe@example.com", "password");

		Chamado c2 = new Chamado(Prioridade.ALTA, Status.ABERTO, "Chamado 02", "Segundo Chamado", tec2, cli2);

		Tecnico tec3 = new Tecnico("Ana Souza", "555555555", "ana.souza@example.com", "password");
		tec3.addPerfil(Perfil.TECNICO);

		Cliente cli3 = new Cliente("Jane Smith", "999999999", "jane.smith@example.com", "password");

		Chamado c3 = new Chamado(Prioridade.BAIXA, Status.ENCERRADO, "Chamado 03", "Terceiro Chamado", tec3, cli3);

		Tecnico tec4 = new Tecnico("Roberto Santos", "111111111", "roberto.santos@example.com", "password");
		tec4.addPerfil(Perfil.TECNICO);

		Cliente cli4 = new Cliente("Maria Oliveira", "222222222", "maria.oliveira@example.com", "password");
